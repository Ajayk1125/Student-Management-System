...
class Login:
   ...
   def __init__(self,root):
      ...
      self.root.title("Login Page for Student Management System")
   ...
   def loginform(self):
      ...
      label2=Label(frame_input,text="Enter your gmail",font=("Goudy old style",20,"bold"),
      ...
      self.password=Entry(frame_input,font=("times new roman",15,"bold"), show ="*",
   ...
   def login(self):
      ...
      if self.email_txt.get()=="" or self.password.get()=="":
         ...
         try:
            ...
            con=pymysql.connect(host='localhost',user='root',password='abc456',
